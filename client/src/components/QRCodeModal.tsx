...
export const QRCodeModal: React.FC<QRCodeModalProps> = ({ isOpen, onClose }) => {
  const defaultUrl = `${window.location.origin}/?mode=student`;
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
            ...
            <div className="flex items-center space-x-1.5 text-xs font-bold text-slate-700">
              ...
              <span>Direct Link: Opens Student Self-Registration Only</span>
            </div>
            <p className="text-[11px] text-slate-500 mt-1 max-w-xs">
              Students scanning this QR code will not see Control Room or Smartboard options.
            </p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-slate-400">
              💡 Tip: If testing on mobile via local Wi-Fi, replace <code className="bg-slate-100 px-1 py-0.5 rounded text-slate-700">localhost</code> with your computer's LAN IP (e.g. <code className="bg-slate-100 px-1 py-0.5 rounded text-slate-700">192.168.1.X</code>).
            </p>
          </div>
